...
export function SocialIcon({ kind, className }: { kind: 'linkedin' | 'github' | 'email' | 'instagram'; className?: string }) {
  const Icon = { linkedin: LinkedInIcon, github: GitHubIcon, email: MailIcon, instagram: InstagramIcon }[kind]
